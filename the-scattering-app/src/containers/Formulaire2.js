...
const Formulaire2 = ({ pageCount, setPageCount, handleInputChange, handleSubmit, fileData, showInputs, setShowInputs, fileJSON}) => {
                    ...
                    if (fileName.endsWith(".json")) {
                      const reader = new FileReader();
                        reader.onload = (event) => {
                          ...
                          // verifier que la valeur de M est bien entre 1 et 50, sinon on met une alert 
                          if (jsonData.numerical_parameter?.M && (jsonData.numerical_parameter.M < 1 || jsonData.numerical_parameter.M > 50)) {jsonData.numerical_parameter.M = 10; alert("La valeur de M est incorrecte. Veuillez respecter le domaine de validité de cette valeur.");}
                      ...
                      <div className="sousCartedsInput">
                        <div className="carteOEM">
                          <CarteSaisie>
                            ...
                            <label htmlFor="polarizationInput">
                              Polarization:
                            </label>
                            <label htmlFor="teRadio">
                              ...
                              <input
                                ...
                                checked={
                                  ...
                                  inputs.electromagnetic_wave.polarization ===
                                    "TE"
                                }
                  ...
                  <div className="carteInfo">
                    ...
                    <div>
                      <CarteSaisie>
                        ...
                        {focusState === 1 && (
                          <img src={schema1} alt="EM incidente" />
                        )}
                        {focusState === 2 && (
                          <img src={schema2} alt="milieu 1" />
                        )}
                        {focusState === 3 && (
                          <img src={schema3} alt="milieu 2" />
                        )}
                        {focusState === 4 && (
                          <img src={schema4} alt="matériau" />
                        )}
                    ...
                    <div className="carte-button">
                      ...
                      <h4>Truncation order </h4>
                          <div className="truncation">
                        <BtnInputVariable inputs={inputs} setInputs={setInputs} showInputs={showInputs} setShowInputs={setShowInputs} section={"numerical_parameter"} fieldName={"M"} handleChange={handleChange} handleFocus={handleFocus} handleBlur={handleBlur} numSchema={1} grandeur={"M"} />
                        </div>
